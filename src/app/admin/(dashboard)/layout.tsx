            ...
            >
                <div className="h-full flex flex-col overflow-hidden">
                    ...
                    <div className="h-16 flex items-center justify-between px-4 border-b border-slate-100 flex-shrink-0">
                        ...
                        {/* Close button - JavaScript controlled, not CSS lg:hidden */}
                        {isMobile && (
                            <button
                                type="button"
                                onClick={() => setIsSidebarOpen(false)}
                                className="w-10 h-10 flex items-center justify-center bg-red-500 hover:bg-red-600 active:bg-red-700 text-white rounded-full shadow-lg"
